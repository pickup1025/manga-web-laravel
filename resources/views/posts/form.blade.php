            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="post" action="{{ isset($post) ? route('posts.update', $post->id) : route('posts.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        ...
                        <div>
                            <x-input-label for="title" value="ชื่อเรื่อง" />
                        ...
                        <div>
                            <x-input-label for="company" value="สำนักพิมพ์" />
                            <x-text-input id="company" name="company" type="text" class="mt-1 block w-full" :value="$post->company ?? old('company')" required autofocus />
                            <x-input-error class="mt-2" :messages="$errors->get('company')" />
                        </div>
                        <div>
                            <x-input-label for="price" value="ราคา" />
                        ...
                        <div>
                            <x-input-label for="content" value="เรื่องย่อ" />
